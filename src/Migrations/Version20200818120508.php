...
final class Version20200818120508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE astrologer_services_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE astrologer_services (id UUID NOT NULL, astrologer VARCHAR(255) NOT NULL, service VARCHAR(255) NOT NULL, price NUMERIC(12, 2) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN astrologer_services.id IS \'(DC2Type:uuid)\'');
    ...
    {
        $this->addSql('DROP SEQUENCE astrologer_services_id_seq CASCADE');
